...
import { addOneProcedureToManyTags } from "./tagsController.js";
...
function saveprocedureComments(id, uId, content, images) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // var log = await addLog(globalWhere,id,uId,methodEnum.add,"New procedure comments was created")
            var log = yield addLog({
                objectType: "procedure",
            ...
            const result = yield procedureModel.updateOne({ _id: id }, { $push: { comments: comment._id, logs: log._id } }, { session });
...
function getAllprocedure(uId, _page, _count, sort) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const policies = yield procedureModel.aggregate([
...
// ASSIGNMENT
function assignUserToprocedure(id, uId, assignees = {
...
function addprocedureTags(id, uId, tags) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // var log = await addLog(globalWhere,id,uId,methodEnum.add,"New Tags are added to the procedure")
            var log = yield addLog({
                objectType: "procedure",
                objectId: procedure._id,
                userId: new Types.ObjectId(uId),
...
// DELETE
function unAssignUserToprocedure(id, uId, assignees = {
    author: [], reviewer: [], approver: []
}) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function deleteprocedure(id, uId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            var auth = yield checkprocedureAccessToUser(id, uId);
            assert(auth, "Auth Failed");
            var procedure = yield procedureModel.findByIdAndDelete(id);
            if (!procedure)
                return {
                    status: false,
                    msg: `No procedure with id: ${id}`,
...
function exportprocedure(id, uId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            assert(auth, "Auth Failed");
            var data = yield pdfExport(procedure === null || procedure === void 0 ? void 0 : procedure.title, procedure === null || procedure === void 0 ? void 0 : procedure.content);
            return {
                status: true,
                data,
